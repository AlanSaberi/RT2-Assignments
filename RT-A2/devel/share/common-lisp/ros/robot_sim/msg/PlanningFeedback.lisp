...
(cl:defmethod cl:initialize-instance :after ((m <PlanningFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_sim-msg:<PlanningFeedback> is deprecated: use robot_sim-msg:PlanningFeedback instead.")))

(cl:ensure-generic-function 'actual_pose-val :lambda-list '(m))
(cl:defmethod actual_pose-val ((m <PlanningFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_sim-msg:actual_pose-val is deprecated.  Use robot_sim-msg:actual_pose instead.")
  (actual_pose m))

(cl:ensure-generic-function 'stat-val :lambda-list '(m))
(cl:defmethod stat-val ((m <PlanningFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_sim-msg:stat-val is deprecated.  Use robot_sim-msg:stat instead.")
  (stat m))
