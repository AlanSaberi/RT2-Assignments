...
(cl:defmethod cl:initialize-instance :after ((m <PlanningGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_sim-msg:<PlanningGoal> is deprecated: use robot_sim-msg:PlanningGoal instead.")))

(cl:ensure-generic-function 'target_pose-val :lambda-list '(m))
(cl:defmethod target_pose-val ((m <PlanningGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_sim-msg:target_pose-val is deprecated.  Use robot_sim-msg:target_pose instead.")
  (target_pose m))
