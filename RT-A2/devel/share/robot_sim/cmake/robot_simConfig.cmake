...
if("TRUE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /root/RT-A2/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /root/RT-A2/devel)
  ...
  set(robot_sim_INSTALL_PREFIX /root/RT-A2/install)
...
if(NOT "/root/RT-A2/devel/include " STREQUAL " ")
  set(robot_sim_INCLUDE_DIRS "")
  set(_include_dirs "/root/RT-A2/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'root <saeed.abdollahi.t@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/RT-A2/src/robot_sim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/RT-A2/devel/lib;/opt/ros/noetic/lib)
