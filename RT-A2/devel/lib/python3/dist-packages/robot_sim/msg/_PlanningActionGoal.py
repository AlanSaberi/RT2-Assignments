...
"""autogenerated by genpy from robot_sim/PlanningActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PlanningActionGoal(genpy.Message):
  ...
  _type = "robot_sim/PlanningActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','robot_sim/PlanningGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = robot_sim.msg.PlanningGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = robot_sim.msg.PlanningGoal()
