...
"""autogenerated by genpy from robot_sim/PlanningActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanningActionResult(genpy.Message):
  ...
  _type = "robot_sim/PlanningActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_sim/PlanningResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = robot_sim.msg.PlanningResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_sim.msg.PlanningResult()
